    ...
    <div className="container">
      ...
      <TableContainer component={Paper} className="table-container">
        <Table className="table">
          ...
          <TableBody>
            <TableRow>
              <TableCell>knight Anggolt</TableCell>
              <TableCell>
            ...
            <TableRow>
              <TableCell>knight Kiaron</TableCell>
              <TableCell>
                <Select value={selectedBoss} onChange={handleSelectChange} className="select">
            ...
            <TableRow>
              <TableCell>knight Grish</TableCell>
              <TableCell>
                <Select value={selectedBoss} onChange={handleSelectChange} className="select">
            ...
            <TableRow>
              <TableCell>knight Inferno</TableCell>
              <TableCell>
                <Select value={selectedBoss} onChange={handleSelectChange} className="select">
