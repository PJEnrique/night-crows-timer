...
import { Anggolt, Kiaron, Grish, Inferno, Anggolt430, Kiaron430, Grish430, Inferno430 } from '../js/bishopside.js';
...
function BishopServer() {
  ...
  return (
    <div className="container">
      <h1>Battlefront Bishop Server Boss Timer</h1>
      <TableContainer component={Paper} className="table-container">
        <Table className="table">
          ...
          <TableBody>
            {[
              { label: 'Bishop Anggolt', bosses: Anggolt, webhook: 'Anggolt' },
              { label: 'Bishop Kiaron', bosses: Kiaron, webhook: 'Kiaron' },
              { label: 'Bishop Grish', bosses: Grish, webhook: 'Grish' },
              { label: 'Bishop Inferno', bosses: Inferno, webhook: 'Inferno' },
