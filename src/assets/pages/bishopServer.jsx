    ...
    <div className="container">
      ...
      <TableContainer component={Paper} className="table-container">
        <Table className="table">
          ...
          <TableBody>
            <TableRow>
              <TableCell>bishop Anggolt</TableCell>
              <TableCell>
            ...
            <TableRow>
              <TableCell>bishop Kiaron</TableCell>
              <TableCell>
                <Select value={selectedBoss} onChange={handleSelectChange} className="select">
            ...
            <TableRow>
              <TableCell>bishop Grish</TableCell>
              <TableCell>
                <Select value={selectedBoss} onChange={handleSelectChange} className="select">
            ...
            <TableRow>
              <TableCell>bishop Inferno</TableCell>
              <TableCell>
                <Select value={selectedBoss} onChange={handleSelectChange} className="select">
